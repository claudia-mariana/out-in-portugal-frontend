        ...
        <div>
            <div>
                <NavLink to={"/api/events"}>
                    <ArrowLeftIcon className="absolute w-6 m-2 text-blue" />
                </NavLink>
            </div>
                            ...
                            <div className="whitespace-no-wrap p-4">
                                ...
                                {event && event.activity && (
                                    <NavLink to={`/api/activities/${event.activity._id}`}>
                                        <p className="text-black text-base inline-block m-2 transition-transform transform hover:scale-110 hover:text-shadow-lg">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <div className="sm:w-1/2 p-4">
                                    <div className="whitespace-no-wrap my-5">
                                        ...
                                        <MapPinIcon className="w-6 text-orange inline-block ml-2 font-extrabold" />
                                    ...
                                    <div className="whitespace-no-wrap my-7">
                                        ...
                                        <p className="text-black text-base m-2">{event.description}</p>
                                    </div>
                                    <div className="whitespace-no-wrap my-7">
                                        <p className="text-black text-base font-semibold ml-2">
                                            Hosted by:
                                    ...
                                    <div className="whitespace-no-wrap my-7">
                                        ...
                                        <p className="text-black text-base ml-2">{event.equipment}</p>
                                    </div>
                                </div>
                                <div className="sm:w-1/2 bg-blue-200 p-4">
                                    <div className="whitespace-no-wrap my-7">
                                        <p className="text-black text-base font-semibold ml-2">
                                            Price:
                                        </p>
                                        <p className="text-black text-base ml-2 ">{event.price}</p>
                                    </div>
                                    <div className="whitespace-no-wrap my-7">
                                        <p className="text-black text-base font-semibold ml-2">
                                            Start Date:{" "}
                                    ...
                                    <div className="whitespace-no-wrap my-7">
                                        ...
                                        <p className="text-black text-base ml-2">{event.duration}</p>
                                    </div>
                                </div>
                            </div>
