            ...
            <div className="flex flex-col items-center bg-white w-[90vw] md:w-[70vw] m-[2vw] shadow-md">
              <div className="relative w-full">
                <img
                  ...
                  alt={activity.title}
                  className="w-full h-[40vh] md:h-[70vh] object-cover rounded-t-md"
                />
              ...
              <div className="relative flex flex-col w-full left-3 ">
                <div className="whitespace-no-wrap my-5">
                  <p className="text-black text-xl font-semibold inline-block m-2">
                    Category:
                  </p>
                  <span className="text-black bg-yellow text-xl px-1 py-1 rounded-md">
                    {activity.category}
                  </span>
  
                  <div className="whitespace-no-wrap my-5">
                    <p className="text-black text-xl font-semibold m-2">
                      Description:
                    </p>
                ...
                <div className="flex-grow whitespace-nowrap">
                  {activity.events && activity.events.length > 0 ? (
                    activity.events.map((event) => (
                      <div key={event._id} className="whitespace-no-wrap">
                        <NavLink
                          to={`/api/events/${event._id}`}
                          className="block w-full md:w-auto p-2 bg-gray-light text-blue  hover:text-opacity-70 rounded-lg shadow-md hover:shadow-lg transition-shadow"
                        >
